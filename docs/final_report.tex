...
\item We tested the algorithm on a 32-core machine with 32 GB of RAM and a Solid State Drive (SSD).
	...
	pages.
	\item It turns out, we could tune both these parameters using the \verb#/proc/sys/vm/dirty_background_ratio#,
	\verb#/proc/sys/vm/dirty_expire_centisecs#, \verb#/proc/sys/vm/dirty_writeback_centisecs#, 
	and other \verb#/proc/sys/vm/# files, or simply \verb#sysctl#.
